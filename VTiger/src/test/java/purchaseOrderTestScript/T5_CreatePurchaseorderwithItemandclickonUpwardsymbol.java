...
public class T5_CreatePurchaseorderwithItemandclickonUpwardsymbol extends BaseClass {
	@Test(groups={"Regressionsuite"})
	
	public void CreatePurchaseorderwithItemandclickonUpwardsymbol() throws Throwable
	{
