...
public class T4_CreatePurchaseorderwithItemandDelete extends BaseClass{
	@Test(groups={"Regressionsuite"})
	
	public void CreatePurchaseorderwithItemandDelete() throws Throwable, Throwable 
	{
		...
		PurchaseOrderInfoPage pi = new PurchaseOrderInfoPage(driver);
		pi.getDeletionbtn().click();
