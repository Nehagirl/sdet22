...
import com.vtiger.pomrepositorylib.AddServiceSuccess;
...
public class T_07CreatePurchaseorderwithItemandAddService {
		static {
	...
	public void CreatePurchaseorderwithItemandAddService()  throws Throwable {
    ...
    PurchaseOrderpage pocreate = new PurchaseOrderpage(driver);
    ...
    pocreate.PurcharseOrderPage(sub, bill, ship ,venName,proName,quantity);
    
    //verifyyyyyyyyyyyyyyyyyyyyy
    AddServiceSuccess addserv = new AddServiceSuccess(driver);
    wedutil.waitForElementVisibility(driver, addserv.getAddservsuccess());
    String success2 = addserv.getAddservsuccess().getText();
    if(success2.contains(proName)) {
