...
import com.vtiger.pomrepositorylib.PurchaseOrderInfoPage;
...
public class T_10UpwardArrow {
	static {
		System.setProperty("webdriver.chrome.driver","./driver/chromedriver.exe");
	}
@Test 
public void UpwardArrow() throws Throwable {
		...
		PurchaseOrderpage pocreate2 = new PurchaseOrderpage(driver);
		...
		pocreate2.PurcharseOrderPageUpArrow(sub, bill, ship ,venName,proName,quantity);
	
	


//4.....verify
	AppProductSuccess pursuccess = new AppProductSuccess(driver);
	wedutil.waitForElementVisibility(driver, pursuccess.getAddprosuccessmsg());
	String success3 = pursuccess.getAddprosuccessmsg().getText();
	if(success3.contains(proName))
